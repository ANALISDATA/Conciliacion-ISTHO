...
def acceso_permitido():
    ...
    with centro:
        with st.container(key="login_card"):
            # El título dice "Sistema de Conciliaciones ISTHO" y no "Conciliación
            # Bancaria" a propósito: esta clave abre las DOS apps (queda en
            # session_state, compartido entre páginas), así que si alguien entra por acá
            # primero, el título no debe sonar como si fuera solo para este proceso.
            login_encabezado("Sistema de Conciliaciones ISTHO", "Elige el proceso que necesitas")
