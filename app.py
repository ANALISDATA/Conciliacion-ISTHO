...
from ui import (acceso_permitido, icono, inject_css, menu_css, menu_encabezado, menu_pie,
                 menu_tarjeta)
...
with col1:
    menu_tarjeta(
        "bancario", icono("banco", 46, grosor=1.5), "Cruce Bancario",
...
with col2:
    menu_tarjeta(
        "dian", icono("documento", 46, grosor=1.5), "Cruce DIAN",
